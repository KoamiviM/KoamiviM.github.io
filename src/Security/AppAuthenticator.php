...
class AppAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if(empty($user->getIsActive()) || $user->getIsActive() == false){
            throw new CustomUserMessageAuthenticationException(('Votre compte n\'est pas activé. Veuillez cliquer sur le lien d\'activation envoyé à l\'adresse '. $credentials['email']));
        }
